...
# Load course data
course_data = pd.read_csv('models/course_data.csv')

# Load education recommendation model and scaler
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
with open(os.path.join(BASE_DIR, 'models/model.pkl'), 'rb') as file:
